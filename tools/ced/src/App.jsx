    ...
    <div ref={printRef} style={{ minHeight: "100vh", background: T.bg, fontFamily: T.sans, color: T.textPrimary }}>
      ...
      <div style={{ background: T.headerBg, borderBottom: `1px solid ${T.headerBorder}`, padding: "18px 48px" }}>
        <div style={{ maxWidth: 960, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontFamily: T.mono, fontSize: 9, letterSpacing: "0.16em", textTransform: "uppercase", color: T.accent, marginBottom: 4 }}>Commercial Execution · Portfolio Diagnostic</div>
            <div style={{ fontFamily: T.serif, fontSize: 18, fontWeight: 700, color: "#f1f5f9", letterSpacing: "-0.01em" }}>Commercial Execution Diagnostic</div>
          </div>
          <div style={{ fontFamily: T.mono, fontSize: 9, color: "#334155", textAlign: "right", lineHeight: 1.7 }}>
            David Hopper<br />dahopper.com
          </div>
        </div>
      </div>
